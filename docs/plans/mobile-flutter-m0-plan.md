...
M1 本地阅读闭环已经实现:订阅地址输入、端上抓取解析、SQLite 落库、混合收件箱、全部/未读筛选、已读、收藏、分页、单源/全量刷新、删除订阅、本地 FTS 搜索、静态 HTML 阅读页、安全外链、持久化代理设置以及 OPML 导入/导出已接入 UI。全文抓取仍未完成;AI、自托管连接和完整视觉打磨不进入 M1。

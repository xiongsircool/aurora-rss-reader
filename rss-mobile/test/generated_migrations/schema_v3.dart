...
class Entries extends Table with TableInfo<Entries, EntriesData> {
  ...
  late final GeneratedColumn<int> contentExtractedAt = GeneratedColumn<int>(
...
class EntriesData extends DataClass implements Insertable<EntriesData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || contentExtractedAt != null) {
      map['content_extracted_at'] = Variable<int>(contentExtractedAt);
    }
  ...
  factory EntriesData.fromJson(
    ...
    return EntriesData(
      ...
      contentExtractedAt: serializer.fromJson<int?>(json['contentExtractedAt']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'contentExtractedAt': serializer.toJson<int?>(contentExtractedAt),
  ...
  EntriesData copyWith({
    ...
    Value<int?> contentExtractedAt = const Value.absent(),
...
class EntriesCompanion extends UpdateCompanion<EntriesData> {
  ...
  final Value<int?> contentExtractedAt;
  ...
  static Insertable<EntriesData> custom({
    ...
    Expression<int>? contentExtractedAt,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (contentExtractedAt.present) {
      map['content_extracted_at'] = Variable<int>(contentExtractedAt.value);
    }
